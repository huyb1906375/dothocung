                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <select name="cboMenu" class="form-control" style="width:100%">
								...
								<option <?php if($this->session->userdata('cm_loai_menu') == "LeftMenu") echo "selected";?> value="LeftMenu">Left Menu</option>
								<option <?php if($this->session->userdata('cm_loai_menu') == "RightMenu") echo "selected";?> value="RightMenu">right Menu</option>
