...
<form name="frm" action="<?php echo base_url() ?>admin/giaodich/edit/<?php echo $row['gd_id'] ?>" method="post"  enctype="multipart/form-data" >
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
							...
							<div class='input-group date' id='datetimepicker1'>
								<input id="txtNgayLap" name="txtNgayLap" type='text' class="form-control"  value="<?php echo date('Y-m-d H:i:s',strtotime($row["gd_thoi_gian"]));?>"  readonly="readonly"/>
						...
						<div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtNoiDung" name="txtNoiDung" value="<?php echo $row["gd_noi_dung"];?>" style="width:100%">
							<div class="error" id="noidung_error"><?php echo form_error('txNoiDung')?></div>
                        </div>
                        
						<div class="form-group">
                            <label>Số tiền:</label>
                            <input type="text" class="form-control" id="txtSoTien" name="txtSoTien" value="<?php echo number_format($row["gd_so_tien"]);?>" style="width:100%" onkeyup="FormatNumber(this);">
