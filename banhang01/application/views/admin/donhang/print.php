...
<script src="/public/js/TTHJScript.js"></script>
<style type="text/css" media="print">
	@page
	{
		margin: 0cm 0.5cm 0.3cm 0.5cm;
		/*size: auto;
		margin: 0;*/
	}
	...
	body
	{
		margin: 2mm 2mm 2mm 2mm; -webkit-print-color-adjust: exact !important;
	...
	<div id="donhang">
		<div id="container" style="width: 800px;">
			...
			<table width="100%" cellpadding="5" cellspacing="0" style="margin-top: 20px;margin-bottom: 20px;">
				...
				<tr>
                    <td style="width: 300px; text-align: center; padding-top: 50px;"><b><?php echo $donhang["dh_ten"];?></b></td>
                    <td>&nbsp;</td>
					<td style="width: 300px; text-align: center;padding-top: 50px;"><b><?php echo $user["nd_ten"];?></b></td>
                </tr>
            </table>
        </div>
    </div>
