...
<form name="frm" action="<?php echo base_url() ?>admin/mainmenu/edit/<?php echo $row['cm_id'] ?>" method="post"  enctype="multipart/form-data" >
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo base_url() ?>admin/mainmenu">Menu chính</a></li>
    <li>[Sửa]</li>
  </ol>
</section>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="cboMenuCha" class="form-control" style="width:100%">
