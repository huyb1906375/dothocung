...
foreach ($parent as $p) 
{
	...
	foreach ($child as $c) 
	{
		...
		{
			$option.="<option ".(($row['cm_id_parent'] == $c2["cm_id"])?"selected":"")." value='".$c2["cm_id"]."'>|----------".$c2["cm_ten"]."</option>";
		}
	}
}

?>
<form name="frm" action="<?php echo base_url() ?>admin/chuyenmucvideo/edit/<?php echo $row['cm_id'] ?>" method="post"  enctype="multipart/form-data" >
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo base_url() ?>admin/chuyenmuc">Chuyên mục video</a></li>
    <li>[Sửa]</li>
  </ol>
</section>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <select name="cboTrangThai" class="form-control" style="width:100%">
								<option <?php if($row['cm_trang_thai'] == 0) echo "selected";?> value="0">Không hiển thị</option>
                                <option <?php if($row['cm_trang_thai'] == 1) echo "selected";?> value="1">Hiển thị</option>
                            </select>
                        </div>
						<div class="form-group">
                            <label>Menu:</label>
                            <select name="cboMenu" class="form-control" style="width:100%">
								<option <?php if($row['cm_menu'] == 0) echo "selected";?> value="0">Không hiển thị</option>
                                <option <?php if($row['cm_menu'] == 1) echo "selected";?> value="1">Hiển thị</option>
                            </select>
                        </div>
						<div class="form-group">
                            <label>Nổi bật:</label>
                        ...
                        <div class="form-group">
                            ...
                            <a class="btn btn-primary btn-sm" href="admin/chuyenmucvideo" role="button">
