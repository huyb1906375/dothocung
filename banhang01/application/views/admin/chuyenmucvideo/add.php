...
foreach ($parent as $p) 
{
	...
	foreach ($child as $c) 
	{
		...
		{
			$option.="<option ".(($this->session->userdata('cm_id_parent') == $c2["cm_id"])?"selected":"")." value='".$c2["cm_id"]."'>|----------".$c2["cm_ten"]."</option>";
		}
	}
}

?>
<form name="frm" action="<?php echo base_url() ?>admin/chuyenmucvideo/add" method="post"  enctype="multipart/form-data" >
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo base_url() ?>admin/chuyenmucvideo">Chuyên mục video</a></li>
    <li>[Thêm]</li>
  </ol>
</section>
