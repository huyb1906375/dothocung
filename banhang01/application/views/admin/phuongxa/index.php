<form name="frm" action="<?php echo base_url() ?>admin/phuongxa" method="post"  enctype="multipart/form-data">
            ...
            <div class="box box-primary">
                <div class="box-body">
					...
					<div class="form-group col-md-3">
						...
						<select name="cboTinhThanh" class="form-control select2" style="width:100%" onchange="lay_ds_quan_huyen(this.value)">
					...
					<div class="form-group col-md-4">						
                        ...
                        <div class="input-group">
							...
							<a href="<?php echo base_url();?>admin/phuongxa/add">
                                ...
                                <tbody>
                                    ...
                                    <tr>			   					               
                                        <td class="text-center" style="width:20px"> 
                                            <input type="checkbox" class="checkbox" name="id[]" value="<?php echo $row["px_id"];?>"/>
                                        </td>
                                        <td>&nbsp;<?php echo $row["px_ten"];?></td>
										<td>&nbsp;<?php echo $row["px_mo_ta"];?></td>
                                        <td class="text-center">
                                            <?php 
                                            if ($row["px_trang_thai"]==1)
                                            {
                                            ?>					 
                                                <a href="<?php echo 'admin/phuongxa/hide_status/'.$row["px_id"]; ?>" ><span class="glyphicon glyphicon-ok-circle mauxanh18"></span></a>
                                            <?php
                                            }
                                            else
                                            {
                                            ?>
                                                 <a href="<?php echo 'admin/phuongxa/show_status/'.$row["px_id"]; ?>" ><span class="glyphicon glyphicon-remove-circle maudo"></span></a>
                                            <?php
                                            }
                                            ?>
                                        </td>
                                        ...
                                        <td class="text-center">                
                                            <a class="btn btn-success btn-xs" href="<?php echo 'admin/phuongxa/edit/'.$row["px_id"]; ?>" role="button" > <span class="glyphicon glyphicon-edit"></span> Sửa</a>                
                                        </td>
                                        <td class="text-center">                
                                            <a class="btn btn-danger btn-xs" href="<?php echo 'admin/phuongxa/delete/'.$row["px_id"]; ?>"  onclick="return confirm('Bạn có chắc muốn xóa không?')"  role="button"> <span class="glyphicon glyphicon-trash"></span> Xóa</a>                
                                        </td>	
...
function lay_ds_quan_huyen(tt_id){
