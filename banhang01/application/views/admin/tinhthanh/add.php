...
<form name="frm" action="<?php echo base_url() ?>admin/tinhthanh/add" method="post"  enctype="multipart/form-data" >
                    ...
                    <div class="col-md-6">
						...
						<div class="form-group">
                            ...
                            <select name="cboTrangThai" class="form-control" style="width:100%">
								<option <?php if($this->session->userdata('tt_trang_thai') == 0) echo "selected";?> value="0">Chưa kích hoạt</option>
                                <option <?php if($this->session->userdata('tt_trang_thai') == 1) echo "selected";?> value="1">Kích hoạt</option>
                            </select>
                        </div>
