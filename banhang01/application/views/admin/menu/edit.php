...
<form name="frm" action="<?php echo base_url() ?>admin/menu/edit/<?php echo $row['m_id'] ?>" method="post"  enctype="multipart/form-data" >
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
						...
						<div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtTen" name="txtTen" value="<?php echo $row['m_ten'] ?>" style="width:100%">
						...
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" class="form-control" id="txtLink" name="txtLink" value="<?php echo $row['m_link']; ?>" style="width:100%">
						...
						<div class="form-group">
                            ...
                            <select name="cboLoaiLink" class="form-control"  style="width:100%; ">
                                <option value="_blank" <?php if($row['m_loai_link'] == '_blank') echo "selected"; else echo "";?>>Tạo trang mới</option>
                                <option value="_parent" <?php if($row['m_loai_link'] == '_parent') echo "selected"; else echo "";?>>Chuyển trang</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <div id="upload-image-box">                            	          
								<div class="item">
                                    <label for="fileHinhAnh">
                                        ...
                                        <img class="thumbnail form-control" src="uploads/menu/<?php echo $img;?>"/>         
                                    </label>
