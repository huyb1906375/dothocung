...
$id_news = $row['sp_id'];
?>
<form name="frm" action="<?php echo base_url();?>admin/sanpham/edit/<?php echo $row['sp_id'];?>" method="post"  enctype="multipart/form-data"  onsubmit="return checkValue();">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-9">
						...
						<div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtTen" name="txtTen" value="<?php echo $row['sp_ten']; ?>" style="width:100%">
							<div class="error" id="password_error"><?php echo form_error('txtTen')?></div>
							<input type="hidden" class="form-control" id="txtMa" name="txtMa" value="<?php echo $row['sp_ma']; ?>" style="width:100%">
							<input type="hidden" class="form-control" id="txtID" name="txtID" value="<?php echo $row['sp_id']; ?>" style="width:100%">
                        </div>
						<div class="form-group">
                            <label>Tóm tắt:</label>
                            <textarea name="txtTomTat" id="txtTomTat" class="form-control" ><?php echo $row['sp_tom_tat']; ?></textarea>
                        </div>
						<div class="form-group">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab_chitiet">
										<div class="form-group">
											...
											<textarea name="txtChiTiet" id="txtChiTiet" class="form-control" ><?php echo $row['sp_chi_tiet']; ?></textarea>
									...
									<div class="tab-pane" id="tab_chitiet2">
										<div class="form-group">
											<textarea name="txtChiTiet2" id="txtChiTiet2" class="form-control" ><?php echo $row['sp_chi_tiet2']; ?></textarea>
											<script>CKEDITOR.replace('txtChiTiet2');</script>
										</div>
									</div>
									<div class="tab-pane" id="tab_chitiet3">
										<div class="form-group">
											<textarea name="txtChiTiet3" id="txtChiTiet3" class="form-control" ><?php echo $row['sp_chi_tiet3']; ?></textarea>
                    ...
                    <div class="col-md-3"> 
						...
						<div class="form-group">
                            ...
                            <input type="text" id="txtGiaThiTruong" name="txtGiaThiTruong" value="<?php echo number_format($row['sp_gia_thi_truong']);;?>" onkeyup="FormatNumber(this);" onfocus="this.setSelectionRange(0,this.value.length)"  class="form-control f-bold" /> 
                        </div>
						<div class="form-group">
                            <label>Giá bán:</label>
                            <input type="text" id="txtGiaBan" name="txtGiaBan" value="<?php echo number_format($row['sp_gia_ban']);?>" onkeyup="FormatNumber(this)" onfocus="this.setSelectionRange(0,this.value.length)"  class="form-control f-bold" /> 
                        </div>
						...
						<div class="form-group">
							...
							<div class="col-md-12">
								<div class="col-md-6">
									<div class="checkbox">										
										<input id="chkNoiBat" name="chkNoiBat" type="checkbox" <?php if($row['sp_noi_bat'] == 1) echo "checked";?> value="1">Nổi bất										
									</div>
								</div>
								<div class="col-md-6">
									<div class="checkbox">										
										<input id="chkMoi" name="chkMoi" type="checkbox" <?php if($row['sp_moi'] == 1) echo "checked";?> value="1">Mới										
									</div>
								</div>
								<div class="col-md-6">
									<div class="checkbox">										
										<input id="chkKhuyenMai" name="chkKhuyenMai" type="checkbox" <?php if($row['sp_khuyen_mai'] == 1) echo "checked";?> value="1">Khuyến mãi									
									</div>
								</div>
								<div class="col-md-6">
									<div class="checkbox">										
										<input id="chkBanChay" name="chkBanChay" type="checkbox" <?php if($row['sp_ban_chay'] == 1) echo "checked";?> value="1">Bán chạy										
									</div>
								</div>
							</div>
                        </div>
						<div class="form-group">
                            ...
                            <select name="cboTrangThai" class="form-control" style="width:100%">
								<option <?php if($row['sp_trang_thai'] == 0) echo "selected";?> value="0">Chưa xuất bản</option>
                                <option <?php if($row['sp_trang_thai'] == 1) echo "selected";?> value="1">Xuất bản</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <div id="upload-image-box">                            	          
								<div class="item">
                                    <label for="fileHinhAnh">
                                        <img class="thumbnail form-control" src="uploads/sanpham/<?php echo $img;?>"/>            
                                    </label>
						...
						<div class="form-group">
                        	...
                        	<div id="image_list">
                            	<?php
                            	$items = $this->sanpham_model->lay_danh_sach_san_pham_hinh($row['sp_id']);
                                foreach($items as $item)
                                {
                                ?>
                                <div class="image_item">
                                    
                                    <a onclick="loadDuLieu('image_list','admin/ajax/xoa_san_pham_hinh/<?php echo $item['sph_id'];?>/<?php echo $item['sph_sp_id'];?>')" class="image_item_delete"></a>
