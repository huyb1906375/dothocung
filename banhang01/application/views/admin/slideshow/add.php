...
<form name="frm" action="<?php echo base_url() ?>admin/slideshow/add" method="post"  enctype="multipart/form-data" >
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo base_url() ?>admin/slideshow">Liên kết</a></li>
    <li>[Thêm]</li>
  </ol>
</section>
                    ...
                    <div class="col-md-3">
						...
						<div class="form-group">
                            ...
                            <select name="cboLoaiLink" class="form-control"  style="width:100%; ">
                                <option value="_blank" <?php if($this->session->userdata('slide_loai_link') == '_blank') echo "selected"; else echo "";?>>Tạo trang mới</option>
                                <option value="_parent" <?php if($this->session->userdata('slide_loai_link') == '_parent') echo "selected"; else echo "";?>>Chuyển trang</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="cboTrangThai" class="form-control" style="width:100%">
								<option <?php if($this->session->userdata('slide_trang_thai') == 0) echo "selected";?> value="0">Chưa xuất bản</option>
                                <option <?php if($this->session->userdata('slide_trang_thai') == 1) echo "selected";?> value="1">Xuất bản</option>
                            </select>
                        </div>
