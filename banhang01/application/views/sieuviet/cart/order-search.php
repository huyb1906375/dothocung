		...
		<div class="row">
			<div class="col-md-12">
				<div class="checkout-form-list mb-30">
					<form name="frmTraCuu" action="<?php echo base_url();?>tra-cuu-don-hang.html" method="POST" onsubmit="return KiemTraDatHang();">
					<table border="0">
						<tr>
							<td width="120px"><label>ID đơn hàng: <span class="required">*</span></label></td>
							<td width="200px">
								<input type="text" class="form-control" id="txtDHID" name="txtDHID" value=""/>
								<div class="error"><?php echo form_error('txtDHID')?></div>
							</td>
							<td>
								<input type="submit" name="btnTraCuuDonHang" id="btnTraCuuDonHang" value="Tra cứu" class="button" style="margin-left: 10px; margin-top: 0px;"/>
							</td>
						</tr>
					</table>
					</form>
